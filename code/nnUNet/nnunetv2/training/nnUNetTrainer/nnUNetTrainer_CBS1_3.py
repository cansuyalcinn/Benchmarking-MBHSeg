...
# use combined loader but only give the first 2 labeled to the model.
...
class nnUNetTrainerCoBoundarySeg1_3(nnUNetTrainerNoDeepSupervision):
    """
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        # CANSU: JUST SELECT THE 2 LABELED AND ASISGN AS DATA
        data = data[:self.labeled_bs]  # Use only the first 2 labeled samples
...
class nnUNetTrainerCoBoundarySeg_100epochs1_3(nnUNetTrainerCoBoundarySeg1_3):
    def __init__(
            self,
            plans: dict,
            configuration: str,
