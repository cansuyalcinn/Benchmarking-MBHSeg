...
class nnUNetTrainerCoBoundarySeg4(nnUNetTrainerNoDeepSupervision):
    """
...
class nnUNetTrainerCoBoundarySeg_100epochs4(nnUNetTrainerCoBoundarySeg4):
    def __init__(
            self,
            plans: dict,
            configuration: str,
