...
class nnUNetTrainerCoBoundarySeg5_4_8_1(nnUNetTrainerNoDeepSupervision):
    """
    ...
    def calculate_ML_FP_UA(self, y_all, outfeats, outputs_seg, y_all_fp, i, j, num_classes, consistency_criterion, uncertain_ratio=0.10, λ=0.2):
        '''
...
class nnUNetTrainerCoBoundarySeg_100epochs5(nnUNetTrainerCoBoundarySeg5_4_8_1):
    def __init__(
            self,
            plans: dict,
            configuration: str,
