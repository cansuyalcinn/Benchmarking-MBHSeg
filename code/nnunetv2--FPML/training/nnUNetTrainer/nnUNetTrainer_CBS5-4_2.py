...
class DualDecoderWrapper(nn.Module):
    ...
    def __init__(self, encoder, decoder, n_classes, num_FP=1):
        super().__init__()
...
class nnUNetTrainerCoBoundarySeg5_4_2(nnUNetTrainerNoDeepSupervision):
    """
...
class nnUNetTrainerCoBoundarySeg_100epochs5(nnUNetTrainerCoBoundarySeg5_4_2):
    def __init__(
            self,
            plans: dict,
            configuration: str,
