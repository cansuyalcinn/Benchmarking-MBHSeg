...
# 5-4_8_4: 
# this is for the ablation study if num_FP = 5.
...
class DualDecoderWrapper(nn.Module):
    ...
    def __init__(self, encoder, decoder, n_classes, num_FP=5):
        super().__init__()
...
class nnUNetTrainerCoBoundarySeg5_4_8_4(nnUNetTrainerNoDeepSupervision):
    """
...
class nnUNetTrainerCoBoundarySeg_100epochs5(nnUNetTrainerCoBoundarySeg5_4_8_4):
    def __init__(
            self,
            plans: dict,
            configuration: str,
