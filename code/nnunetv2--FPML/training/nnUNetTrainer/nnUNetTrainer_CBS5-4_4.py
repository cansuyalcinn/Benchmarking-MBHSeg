...
class nnUNetTrainerCoBoundarySeg5_4_4(nnUNetTrainerNoDeepSupervision):
    """
...
class nnUNetTrainerCoBoundarySeg_100epochs5(nnUNetTrainerCoBoundarySeg5_4_4):
    def __init__(
            self,
            plans: dict,
            configuration: str,
