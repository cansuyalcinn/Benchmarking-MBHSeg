...
class FeaturePerturbation(nn.Module):
    def __init__(self, lam=1.0, kap=0.05, eps=1e-6, use_gpu=True):
...
class nnUNetTrainerCoBoundarySeg5_4_5(nnUNetTrainerNoDeepSupervision):
    """
...
class nnUNetTrainerCoBoundarySeg_100epochs5(nnUNetTrainerCoBoundarySeg5_4_5):
    def __init__(
            self,
            plans: dict,
            configuration: str,
