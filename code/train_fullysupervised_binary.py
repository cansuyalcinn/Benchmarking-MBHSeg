...
from dataloders.mbhseg import MBHSegDataset, RandomCrop, RandomRotFlip, ROICrop, ToTensor
from utils import losses
from networks.net_factory_3d import net_factory_3d
from torch.cuda.amp import GradScaler, autocast

parser = argparse.ArgumentParser()
parser.add_argument('--data_root', type=str,default='../data', help='Root data path')
parser.add_argument('--dataset', type=str, default='mbhseg24', help='Dataset: mbhseg24 or mbhseg25')
parser.add_argument('--labeled_num', type=int, default=20, help='labeled data')
parser.add_argument('--fold', type=int, default=0, help='Cross-validation fold (0-4)')
parser.add_argument('--exp', type=str,default='MBHSeg_FullySupervised', help='experiment_name')
...
def train(args, snapshot_path):
    model = net_factory_3d(net_type=args.model, in_chns=1, class_num=args.num_classes)
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num % 20 == 0:
                ...
                image = output_soft[0, 1:2, :, :, 20:61:10].permute(
                    3, 0, 1, 2).repeat(1, 3, 1, 1)
            ...
            if iter_num > 0 and iter_num % 10 == 0:
                ...
                avg_metric = test_all_case(
                    ...
                    test_list='/media/cansu/DiskSpace/Cansu/Benchmarking-MBHSeg/data/splits/mbhseg24/fold_0/test.txt',
